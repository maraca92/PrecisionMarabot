# utils.py - Grok Elite Signal Bot v27.12.12 - Utility Functions
"""
Utility functions for the bot.

v27.12.12: FIXED RENDER LOGGING
- setup_logging() now outputs to stdout with StreamHandler
- Added flush_logs() for immediate output
- Added periodic heartbeat logging support
- All logging now visible in Render dashboard
...
# ============================================================================
# LOGGING SETUP - v27.12.12 FIXED FOR RENDER
# ============================================================================
def setup_logging():
    """
    Configure logging to output to stdout for Render visibility.
    
    v27.12.12: 
    - Uses StreamHandler to stdout explicitly
    - Disables buffering for immediate log visibility
    - Sets up proper formatting for Render logs
    """
    ...
    # Create stdout handler with immediate flush
    stdout_handler = logging.StreamHandler(sys.stdout)
    stdout_handler.setLevel(getattr(logging, LOG_LEVEL))
    
    # Use simpler format for better Render readability
    ...
    print("[INIT] Logging configured for Render visibility", flush=True)


def flush_logs():
    """Force flush all log handlers - call after important log messages."""
...
def log_with_flush(level: str, message: str):
    """Log a message and immediately flush for Render visibility."""
