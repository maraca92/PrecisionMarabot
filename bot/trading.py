            ...
            if trade.get('active'):
                ...
                if hit_tp1 and current_sl == sl and not trade.get('tp1_exited'):
                    ...
                    if COUNTER_TREND_TP1_ONLY and not use_tp2:
                        ...
                        net_tp1_pnl_pct = net_tp1_pnl_usdt / current_capital * 100 if current_capital > 0 else 0
                        ...
                        await send_throttled(
                            ...
                            f"Closed 100% @ {format_price(price)} -> +{net_tp1_pnl_pct:+.2f}%\n"
                            f"_Counter-trend trades exit fully at TP1_",
                            parse_mode='Markdown'
                        )
                        ...
                        await send_throttled(
                            CHAT_ID,
                            f"**TP1 PARTIAL EXIT** {clean_symbol.replace('/USDT','')}\n\n"
