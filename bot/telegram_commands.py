...
**Testing & Analysis:**
- `/backtest` - Quick 90-day backtest
- `/backtest_pro [SYM] [DAYS]` - Professional backtest with Monte Carlo
- `/backtest_all` - Multi-symbol backtest
- `/validate` - Monte Carlo validation
...
**💡 v27.12.15:** Pro Backtest with Leverage-Adjusted PnL, Monte Carlo, Profit Factor"""
